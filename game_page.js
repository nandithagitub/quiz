...
function check(){
    ...
    if(get_word == real_answer){
        if(answer_turn == "player_1"){
            update_score_1 = player_1_score+1;
            document.getElementById("math_score_1").innerHTML = update_score_1;
        }
        else{
            update_score_2 = player_2_score+1;
            document.getElementById("math_score_2").innerHTML = update_score_2;
        }
    }
